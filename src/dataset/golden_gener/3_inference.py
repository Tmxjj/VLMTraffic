...
if __name__ == "__main__":
    ...
    parser.add_argument("--scenario", type=str, default="Hangzhou", help="Scenario name (e.g. JiNan)")
    parser.add_argument("--route_file", type=str, default="anon_4_4_hangzhou_real_emergy.rou", help="Route file name")
