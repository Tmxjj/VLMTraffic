...
LastEditTime: 2026-03-03 09:51:56
...
if __name__ == '__main__':
    ...
    netxml = path_convert("../data/raw/JiNan/env/jinan.net.xml")
    print(f"Converting SUMO Net: {netxml} to 3D assets...")
    sumonet_to_3d = SumoNet3D(net_file=netxml)
    sumonet_to_3d.to_glb(glb_dir=path_convert(f"../data/raw/JiNan/3d_assets/"))