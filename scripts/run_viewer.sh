...
###
 ...
 # @LastEditTime: 2026-03-09 21:25:37
...
# streamlit run scripts/1_viewer.py -- --path data/sft_dataset/JiNan/anon_3_4_jinan_real_2500.rou/dataset.jsonl &
...
# streamlit run scripts/3_viewer.py -- --path data/sft_dataset/JiNan/anon_3_4_jinan_real_2000.rou/dataset_auto_annotated_final.jsonl &
